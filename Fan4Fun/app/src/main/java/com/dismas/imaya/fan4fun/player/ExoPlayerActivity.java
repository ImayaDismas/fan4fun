...
package com.dismas.imaya.fan4fun.player;

import com.dismas.imaya.fan4fun.R;
import com.dismas.imaya.fan4fun.player.exoplayer.DashRendererBuilder;
import com.dismas.imaya.fan4fun.player.exoplayer.EventLogger;
import com.dismas.imaya.fan4fun.player.exoplayer.ExtractorRendererBuilder;
import com.dismas.imaya.fan4fun.player.exoplayer.HlsRendererBuilder;
import com.dismas.imaya.fan4fun.player.exoplayer.NPExoPlayer;
import com.dismas.imaya.fan4fun.player.exoplayer.NPExoPlayer.RendererBuilder;
import com.dismas.imaya.fan4fun.player.exoplayer.SmoothStreamingRendererBuilder;
